            ...
            itemBuilder: (context,index) {
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                  Text("User id:${samplePosts[index].userId}",style: TextStyle(fontSize: 22),),
                  Text("id:${samplePosts[index].id}",style: TextStyle(fontSize: 22),),
                  Text("title:${samplePosts[index].title}",
                  maxLines: 1,style: TextStyle(fontSize: 22),),
                  Text("body:${samplePosts[index].body}",
                  maxLines: 1,style: TextStyle(fontSize: 22),),
                ],),
              );
            }
